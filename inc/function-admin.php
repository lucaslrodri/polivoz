...
function polivoz_custom_settings(){
    ...
    //Galeria
    register_setting('polivoz-config-section-group', 'polivoz_template_galeria_header');
    register_setting('polivoz-config-section-group', 'polivoz_template_galeria_name');
    register_setting('polivoz-config-section-group', 'polivoz_template_galeria_single_header');
    register_setting('polivoz-config-section-group', 'polivoz_template_galeria_nota_musical');
    register_setting('polivoz-config-section-group', 'polivoz_template_galeria_menu');
    //Locais
    register_setting('polivoz-config-section-group', 'polivoz_template_local_header');
    register_setting('polivoz-config-section-group', 'polivoz_template_local_name');
    register_setting('polivoz-config-section-group', 'polivoz_template_local_nota_musical');
    register_setting('polivoz-config-section-group', 'polivoz_template_local_menu');
    //Eventos
    register_setting('polivoz-config-section-group', 'polivoz_template_evento_header');
    register_setting('polivoz-config-section-group', 'polivoz_template_evento_name');
    register_setting('polivoz-config-section-group', 'polivoz_template_evento_nota_musical');
    register_setting('polivoz-config-section-group', 'polivoz_template_evento_menu');
    //Músicas
    register_setting('polivoz-config-section-group', 'polivoz_template_musica_header');
    register_setting('polivoz-config-section-group', 'polivoz_template_musica_name');
    register_setting('polivoz-config-section-group', 'polivoz_template_musica_nota_musical');
...
function polivoz_template_galeria_name(){
    $title_galeria = esc_attr(get_option('polivoz_template_galeria_name'));
...
function polivoz_template_galeria_header(){
    $galeria_header = esc_attr(get_option('polivoz_template_galeria_header'));
...
function polivoz_template_galeria_options(){
    $single_header_galeria = esc_attr(get_option('polivoz_template_galeria_single_header'));
 ...
 function polivoz_template_galeria_nota_musical(){
    $value = esc_attr(get_option('polivoz_template_galeria_nota_musical'));
    if(empty($value)){$value = 'p';}
    echo '<div class="card">';
    echo '<p><input type="text" id="polivoz_template_galeria_nota_musical" class="polivoz_nota_musical_field" pattern="[a-zA-Z]*||[0]{1}" data-postid="' . 15 . '" name="polivoz_template_galeria_nota_musical" value="' . esc_attr($value) . '" maxlength="2" size="4"/>';
...
function polivoz_template_galeria_menu(){
    $value = esc_attr(get_option('polivoz_template_galeria_menu'));
 ...
 function polivoz_template_local_name(){
    $title_local = esc_attr(get_option('polivoz_template_local_name'));
...
function polivoz_template_local_header(){
    $local_header = esc_attr(get_option('polivoz_template_local_header'));
...
function polivoz_template_local_nota_musical(){
    $value = esc_attr(get_option('polivoz_template_local_nota_musical'));
    if(empty($value)){$value = 'o';}
    echo '<div class="card">';
    echo '<p><input type="text" id="polivoz_template_local_nota_musical" class="polivoz_nota_musical_field" pattern="[a-zA-Z]*||[0]{1}" data-postid="' . 14 . '" name="polivoz_template_local_nota_musical" value="' . esc_attr($value) . '" maxlength="2" size="4"/>';
    echo '<span class="nota-musical">'.$value.'</span></p>';
    echo '<p><a href="' . menu_page_url('polivoz-admin-page', false) . '#polivoz-guide-nota-musical" target="_blank"">Aprenda mais sobre notas musicais</a></p>';
    echo '</div>';
 }
 ...
 function polivoz_template_local_menu(){
    $value = esc_attr(get_option('polivoz_template_local_menu'));
    if(empty($value)){$value = 'yes';}
    echo '<div class="card">';
...
//Evento
 ...
 function polivoz_template_evento_name(){
    $title_evento = esc_attr(get_option('polivoz_template_evento_name'));
...
function polivoz_template_evento_header(){
    $evento_header = esc_attr(get_option('polivoz_template_evento_header'));
...
function polivoz_template_evento_nota_musical(){
    $value = esc_attr(get_option('polivoz_template_evento_nota_musical'));
    if(empty($value)){$value = 'j';}
    echo '<div class="card">';
    echo '<p><input type="text" id="polivoz_template_evento_nota_musical" class="polivoz_nota_musical_field" pattern="[a-zA-Z]*||[0]{1}" data-postid="' . 9 . '" name="polivoz_template_evento_nota_musical" value="' . esc_attr($value) . '" maxlength="2" size="4"/>';
    echo '<span class="nota-musical">'.$value.'</span></p>';
    echo '<p><a href="' . menu_page_url('polivoz-admin-page', false) . '#polivoz-guide-nota-musical" target="_blank"">Aprenda mais sobre notas musicais</a></p>';
    echo '</div>';
 }
  ...
  function polivoz_template_evento_menu(){
    $value = esc_attr(get_option('polivoz_template_evento_menu'));
    if(empty($value)){$value = 'yes';}
    echo '<div class="card">';
 ...
 function polivoz_template_musica_name(){
    $title_musica = esc_attr(get_option('polivoz_template_musica_name'));
...
function polivoz_template_musica_header(){
    $musica_header = esc_attr(get_option('polivoz_template_musica_header'));
...
function polivoz_template_musica_nota_musical(){
    $value = esc_attr(get_option('polivoz_template_musica_nota_musical'));
    if(empty($value)){$value = 'q';}
    echo '<div class="card">';
    echo '<p><input type="text" id="polivoz_template_musica_nota_musical" class="polivoz_nota_musical_field" pattern="[a-zA-Z]*||[0]{1}" data-postid="' . 9 . '" name="polivoz_template_musica_nota_musical" value="' . esc_attr($value) . '" maxlength="2" size="4"/>';
    echo '<span class="nota-musical">'.$value.'</span></p>';
    echo '<p><a href="' . menu_page_url('polivoz-admin-page', false) . '#polivoz-guide-nota-musical" target="_blank"">Aprenda mais sobre notas musicais</a></p>';
    echo '</div>';
 }
  ...
  function polivoz_template_musica_menu(){
    $value = esc_attr(get_option('polivoz_template_musica_menu'));
    if(empty($value)){$value = 'yes';}
    echo '<div class="card">';

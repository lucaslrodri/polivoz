...
function polivoz_error_404($title, $args) {
    echo'
...
function polivoz_pagination($postype, $pagenum, $post_per_page,$addressID) {
    if (empty($post_per_page)) {
        $post_per_page = get_option('posts_per_page');
    }
    if ($pagenum != 1) {
        echo '<div class="container text-center" id="pagination">
            ...
            <span class="text">Carregar mais posts&nbsp;&nbsp;</span>
